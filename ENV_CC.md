...
pip install astropt ipykernel datasets einops
```
...
Create venv for astroPT:

```bash
cd /pbs/throng/training/astroinfo2025/soft/astroPT
uv sync
```

Add few more packages if needed:

```bash
uv pip install ipykernel datasets einops
```
